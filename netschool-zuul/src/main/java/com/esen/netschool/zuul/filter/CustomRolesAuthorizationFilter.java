...
import com.esen.netschool.common.bean.JWTToken;
...
//    }
    ...
    public boolean onPreHandle(ServletRequest request, ServletResponse response, Object mappedValue) throws Exception {
        ...
        printWriter.write(new Gson().toJson(new com.esen.netschool.common.bean.ResponseBean(ErrorEnum.ERROR_401.getErrorCode(),ErrorEnum.ERROR_401.getErrorMsg(),"")));
        printWriter.flush();
        servletResponse.setHeader("content-Length", respStr.getBytes().length + "");
        return false;
    }
