package com.esen.netschool.zuul.interceptor;
...
public class SsoInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest servletRequest, HttpServletResponse servletResponse, Object handler) throws Exception {
        ...
        printWriter.write(new Gson().toJson(new com.esen.netschool.common.bean.ResponseBean(ErrorEnum.ERROR_10002.getErrorCode(),ErrorEnum.ERROR_10002.getErrorMsg(),"")));
        printWriter.flush();
